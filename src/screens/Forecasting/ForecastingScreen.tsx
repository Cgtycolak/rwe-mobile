  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>System Direction Forecast</Text>
        <Text style={styles.subtitle}>Energy system forecasting</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.infoText}>
          This screen will display system direction forecasts and predictions.
        </Text>
      </View>
    </ScrollView>
  );
