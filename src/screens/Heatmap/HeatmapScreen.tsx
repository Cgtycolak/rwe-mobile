...
const HeatmapScreen = () => {
  // Natural Gas with DPP and Realtime data
  ...
  const loadHeatmapData = async () => {
    try {
      ...
      if (dataType === 'realtime') {
        response = await apiService.getRealtimeHeatmapData(selectedDate);
      } else {
        response = await apiService.getHeatmapData(selectedDate, version);
      }
